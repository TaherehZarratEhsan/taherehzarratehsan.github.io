...
<div class="row justify-content-sm-center">
    ...
    <div class="col-sm-4 mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/img1.PNG" title="example image" class="img-fluid rounded z-depth-1" %}
    </div>
        <div class="col-sm-4 mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/img_h.JPG" title="example image" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
